...
import { Code2, Loader2, AlertCircle, Mail, Lock, User } from 'lucide-react';
...
export default function Register() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden flex items-center justify-center p-6 animate-fade-in">
      ...
      <div className="absolute bottom-[-30%] left-[-10%] w-[500px] h-[400px] bg-indigo-500/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="relative w-full max-w-md animate-rise">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-white">Join LeetTracker</h1>
